...
const isOwner = [`${setting.ownerNumber}`,"6281220670449@s.whatsapp.net","6281220670449@s.whatsapp.net"].includes(sender) ? true : false
...
var text_ny =`Kamu terdeteksi spam bot tanpa jeda, lakukan perintah setelah 5 detik`
...
switch(command) {
case 'verify':
var yyyyygygy_xxx = 'Lu Udah Verifikasi, jangan ketik lagi ya dek'
...
*_Seputar Cyclone & transaksi_*

${strip}Telpon & Spam blokir 🚫${strip}

_Whatsapp Admin  :_
_Wa.me/6281220670449_
...
case 'menu':{
if (cekUser("id", sender) == null) return reply(mess.OnlyUser)
const gurbot = "6281220670449@s.whatsapp.net"
...
case 'groupbot':
if (cekUser("id", sender) == null) return reply(mess.OnlyUser)
reply(`*PANEL BOT MURAH*
https://chat.whatsapp.com/G7OAf8Mip8922Bm0HFA2FQ`)
break
case 'kur':
case 'kurang':{
if (!isOwner) return reply(mess.OnlyOwner)
...
await sleep(1000)
var owner_nyaa = '6281220670449@s.whatsapp.net'
...
if (!q) return reply('link githubnya mana?\n*Contoh:*\n#gitclone https://github.com/ZassXdOfficial/MenfessV1')
var linknya = q
...
diablosendMessage(from, { image : { url : top.qrCode}, caption : `Payment : ${top.paymentMethod}\nId : ${id}\nJumlah : ${jumlah} Diamond\nScan & Bayar Maksimal 30 detik setelah qr ini keluar`}) 
